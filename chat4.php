...
<body>
    ...
    <nav class="nav2">
        <ul>
            ...
            <main class="divisorNotice">
                <?php
                $idU = $_SESSION['id'];
                $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala4' AND idAnuncio = '1'";
    ...
    <content>
        ...
        ?>
            <p>Sala <?php echo $num; ?> <?php echo $tema; ?></p>
        ...
        ?>
            ...
            <p>Sala <?php echo $num; ?>: <?php echo $tema; ?><a class="roomA" href="<?php echo $maximizaRoom; ?>"><button class="browser-button"><i class="fa fa-window-maximize"></i></button></a></p>
