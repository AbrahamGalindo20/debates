...
<body>
    ...
    <main class="adsTwo">
            <?php
            $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala1' AND idAnuncio = '2'";
            $sqlExecuteAnuncios = mysqli_query($conectar, $sqlAnuncios);
            $assocAnuncios = mysqli_fetch_assoc($sqlExecuteAnuncios);
            ...
            $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala1' AND idAnuncio = '3'";
            $sqlExecuteAnuncios = mysqli_query($conectar, $sqlAnuncios);
            $assocAnuncios = mysqli_fetch_assoc($sqlExecuteAnuncios);
            ...
            $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala1' AND idAnuncio = '4'";
            $sqlExecuteAnuncios = mysqli_query($conectar, $sqlAnuncios);
            $assocAnuncios = mysqli_fetch_assoc($sqlExecuteAnuncios);
