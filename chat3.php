...
<body>
    ...
    <nav class="nav2">
        <ul>
            ...
            <main class="divisorNotice">
                <?php
                $idU = $_SESSION['id'];
                $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala3' AND idAnuncio = '1'";
                ...
                $sqlSentence = "SELECT * FROM noticiasgenerales WHERE idRoom = '3'";
                $sqlExecute = mysqli_query($conectar, $sqlSentence);
                $id = 0;
                while ($sqlAssoc = mysqli_fetch_assoc($sqlExecute)) {
                    $idA = $sqlAssoc['id'];
    ...
    <main class="adsTwo">
            <?php
            $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala3' AND idAnuncio = '2'";
            $sqlExecuteAnuncios = mysqli_query($conectar, $sqlAnuncios);
            $assocAnuncios = mysqli_fetch_assoc($sqlExecuteAnuncios);
            ...
            $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala3' AND idAnuncio = '3'";
            $sqlExecuteAnuncios = mysqli_query($conectar, $sqlAnuncios);
            $assocAnuncios = mysqli_fetch_assoc($sqlExecuteAnuncios);
            ...
            $sqlAnuncios = "SELECT * FROM anuncios WHERE area = 'sala3' AND idAnuncio = '4'";
            $sqlExecuteAnuncios = mysqli_query($conectar, $sqlAnuncios);
            $assocAnuncios = mysqli_fetch_assoc($sqlExecuteAnuncios);
