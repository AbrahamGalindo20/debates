...
<div class="area">
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Gestión <b>Anuncios</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="#addRoom" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Anuncio</span></a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        $datosAdmin = "SELECT * FROM anuncios WHERE estado <> 'Archivado'";
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row['linkAnuncio']; ?></td>
                                <td>
                            ...
                            <div id="editRoom<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/editComercial.php">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label>idAnuncio</label>
                                                    <select class="form-control" name="idAnuncio" id="idAnuncio">
                                                        <option>Selecciona el numero de anuncio</option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="linkAnuncio" id="linkAnuncio" class="form-control" required value="<?php echo $row['linkAnuncio']; ?>">
                                                </div>
                                            </div>
                            ...
                            <div id="deleteRoom<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/deleteComercial.php">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Eliminar Anuncio</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            </div>
                                            <h4 class="modal-title">¿Deseas eliminar el Anuncio con el siguiente id?</h4>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>id</label>
                            ...
                            <div id="archiveRoom<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/archiveComercial.php">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Archivar Anuncio</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            </div>
                                            <h4 class="modal-title">¿Deseas archivar la Anuncio con el siguiente id?</h4>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>id</label>
                                                    <input type="text" name="id" id="id" class="form-control" required value="<?php echo $row['id']; ?>">
    ...
    <div id="addRoom" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="POST" action="./../php/addComercial.php" enctype="multipart/form-data">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="sala">Link Anuncio</label>
                            <input type="text" name="linkAnuncio" id="linkAnuncio" class="form-control" required>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancelar">
