        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Gestión <b>Bloqueo Usuarios</b></h2>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <?php
                                $user = $row['username'];
                                $sqlState = "SELECT * FROM estadousuarios WHERE username = '$user'";
                                $executeState = mysqli_query($conexion, $sqlState);
                                $assoc = mysqli_fetch_assoc($executeState);
                                $estado = $assoc['state'];
                                if ($estado ==  NULL || $estado == '' || $estado == " " || $estado == "Habilitado") {
                                    $estado = "Habilitado";
                                } else {
                                    $estado = "Bloqueado";
                                }
                                ...
                                <td>
                                    <a href="#editState<?php echo $row['id']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                </td>
                            </tr>
                            <!-- Edit User -->
                            <div id="editState<?php $username = $row['id'];
                                                echo $username; ?>" class="modal fade">
                                <?php
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/editState.php">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="username" id="username" class="form-control" required value="<?php echo $username; ?>">
                                            </div>
                            ...
                            <!-- Delete User -->
                            <div id="deleteUser<?php echo $row['username']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
