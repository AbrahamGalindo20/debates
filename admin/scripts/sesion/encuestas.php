...
<div class="area">
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Gestión <b>Encuestas</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="#addRoom" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Encuesta</span></a>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php
                        $datosAdmin = "SELECT * FROM encuestas WHERE estado <> 'Archivado'";
                        ...
                        ?>
                            ...
                            <div id="editRoom<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/editTest.php">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Editar Encuesta</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            </div>
                                            <div class="form-group">
                                                <input type="hidden" name="Usuario" id="Usuario" class="form-control" required value="<?php echo $row['id']; ?>">
                                            </div>
                            ...
                            <div id="deleteRoom<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/deleteTest.php">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Eliminar Encuesta</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            </div>
                                            <h4 class="modal-title">¿Deseas eliminar la encuesta con el siguiente Id?</h4>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>id</label>
                            ...
                            <div id="archiveRoom<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/archiveTest.php">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Archivar Encuesta</h4>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            </div>
                                            <h4 class="modal-title">¿Deseas archivar la Encuesta con el siguiente id?</h4>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>id</label>
                                                    <input type="text" name="id" id="id" class="form-control" required value="<?php echo $row['id']; ?>">
    ...
    <div class="container-xl">
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Encuestas <b>Archivadas</b></h2>
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
        ...
        <div id="addRoom" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST" action="./../php/addTest.php">
                        <div class="modal-header">
