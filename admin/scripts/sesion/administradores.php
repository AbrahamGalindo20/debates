        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-6">
                            <h2>Gestión <b>Administrador</b></h2>
                        </div>
                        <div class="col-sm-6">
                            <a href="#addAdminModal" class="btn btn-success" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span>Agregar Administrador</span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a href="#editAdmin<?php echo $row['id']; ?>" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                    <a href="#deleteAdmin<?php echo $row['id']; ?>" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>

                                </td>
                            </tr>
                            <!-- Edit Admin -->
                            <div id="editAdmin<?php $username = $row['id']; echo $username; ?>" class="modal fade">
                            <?php 
                            $sqlData = "SELECT * FROM admin WHERE id = '$username'";
                            ...
                            ?>
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/editAdmin.php">
                            ...
                            <!-- Delete Admin -->
                            <div id="deleteAdmin<?php echo $row['id']; ?>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <form method="POST" action="./../php/deleteAdmin.php">
                                            ...
                                            <h4 class="modal-title">¿Deseas eliminar el Administrador con el siguiente Usuario?</h4>
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>Username</label>
