                        ...
                        <form action="./editProfile.php" method="POST">
                            ...
                            ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email" class="form-input" placeholder="direcciondeemail@gmail.com" value="<?php echo $row['email']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="username">Edad</label>
                                    <input type="text" id="edad" name="edad" class="form-input" placeholder="Tu nombre o nombre de usuario" value="<?php echo $row['edad']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="username">Sexo</label>
                                    <input type="text" id="sexo" name="sexo" class="form-input" placeholder="Tu nombre o nombre de usuario" value="<?php echo $row['sexo']; ?>" readonly>
                                </div>
